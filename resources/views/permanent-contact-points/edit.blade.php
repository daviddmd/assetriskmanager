        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST"
                          action="{{route('permanent-contact-points.update',$permanent_contact_point->id)}}">
                        @csrf
                        @method("PUT")
                        <div class="mb-6">
                    ...
                    @include("common.delete_prompt",["route" => route('permanent-contact-points.destroy',$permanent_contact_point->id),"message" => __("Are you sure you want to delete this Permanent Contact Point?")])
